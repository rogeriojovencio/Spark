...
if __name__ == "__main__":
    ...
    jcs = spark.read.load("/home/rogerio/pySpark/jcr_scimago/jcs_2020.csv",format="csv", sep=";",inferSchema=True,header=True)
    sci = spark.read.load("/home/rogerio/pySpark/jcr_scimago/scimagojr.csv", format="csv", sep=";", inferSchema=True, header=True)
